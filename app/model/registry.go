...
// supportFiat defines supported fiat currencies
...
// supportCrypto maps crypto symbols to Coingecko ids when available
...
var registry = map[TradeType]TradeTypeConf{
	...
	UsdtTrc20: {
		...
		Network:      conf.Tron,
		Crypto:       USDT,
		Contract:     "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t", // 鍗犱綅锛岀洰鍓嶅疄闄呮病浣跨敤
	...
	EfunBep20: {
		...
		Network:     conf.Bsc,
		Crypto:      EFUN,
		Contract:    conf.EfunBep20,
		Decimal:     conf.EfunBscDecimals,
		AmountRange: usdGeneralRange,
		ExplorerFmt: "https://bscscan.com/tx/%s",
		EndpointKey: RpcEndpointBsc,
	},
	...
	UsdcTrc20: {
		...
		Network:      conf.Tron,
		Crypto:       USDC,
		Contract:     "TEkxiTehnzSmSe2XqrBj4w32RUN966rdz8", // 鍗犱綅锛岀洰鍓嶅疄闄呮病浣跨敤
